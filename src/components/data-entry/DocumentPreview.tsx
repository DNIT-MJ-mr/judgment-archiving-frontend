    ...
    const loadDocument = async () => {
      ...
      try {
        if (isPdf) {
          ...
          const response = await filesApi.downloadJudgmentFile(judgmentId)
        ...
        {loading ? (
          ...
          >
            <iframe
              ...
              className="h-[800px] w-full rounded border bg-white shadow-lg"
              title={sourceOriginalName || 'PDF Document'}
            />
          </div>
        ) : isDocx && docxContent ? (
          <div
